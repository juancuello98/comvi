...
class CancelRequestDTO extends (0, mapped_types_1.PartialType)(action_request_dto_1.ActionRequestDTO) {
}
__decorate([
...
], CancelRequestDTO.prototype, "newStatus", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'nuevo estado de la solicitud respondida',
        name: 'newStatus',
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CancelRequestDTO.prototype, "description", void 0);
